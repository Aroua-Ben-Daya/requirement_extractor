...
def extract_requirements(pdf_path):
    requirements = []
    current_topic = None  # Start with None to detect first topic
    last_valid_topic = None  # Keep track of last detected topic
        ...
        for page_num, page in enumerate(pdf.pages, start=1):
            ...
            if text:
                ...
                for i, line in enumerate(lines):
                    # Topic Detection - Detect only if not empty
                    ...
                    if req_match:
                        ...
                        topic = current_topic if current_topic else (last_valid_topic if last_valid_topic else "Unknown")
